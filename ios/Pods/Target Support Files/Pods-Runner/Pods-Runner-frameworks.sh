...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/another_audio_recorder/another_audio_recorder.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_device_id/flutter_device_id.framework"
