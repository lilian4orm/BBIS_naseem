...
class _HomeWorkState extends State<HomeWork> {
  ...
  _getData() {
    ...
    NotificationsAPI().getNotificationsHomework(data);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: myAppBar('homeWork'.tr),
      body: GetBuilder<NotificationProviderHomeWork>(
                                  ...
                                  Get.to(
                                    () => ShowMessage(
                                      ...
                                      notificationsType: val.data[indexes]
                                          ['notifications_type'],
                                      onUpdate: () {
                                        NotificationsAPI().updateReadHomework(
