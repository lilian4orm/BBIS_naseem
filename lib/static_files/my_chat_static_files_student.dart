...
Widget chatMessageBubbles(Map data, int index, AudioPlayer player) {
  if (data['chat_message_is_deleted']) {
    ...
    if (data['chat_message_type'] == 'text') {
      ...
      String urlAudio =
          Get.put(ChatTeacherListProvider()).contentUrl + data['chat_url'];
...
Widget _pdfChatMessage(Map data, int index) {
  ...
  return GestureDetector(
    ...
    onTap: () => Get.to(() => PdfViewer(
        url: Get.put(ChatTeacherListProvider()).contentUrl + data['chat_url'])),
    child: Row(
      mainAxisSize: MainAxisSize.min,
      mainAxisAlignment:
          isSender ? MainAxisAlignment.start : MainAxisAlignment.end,
        ...
        Expanded(
          child: Container(
              ...
              child: Column(
                ...
                mainAxisSize: MainAxisSize.min,
                children: [
                  imageGridChat(Get.put(ChatTeacherListProvider()).contentUrl,
